...
public class HelloWorld {
    ...
    public int Method4(int a, int b, int c, int d, float e) throws ArithmeticException{
    	if(a == 0) {
    		return 0;
    	}
    	int x = 0;
    ...
    public boolean isBirthday(int year, int month, int day) {
    	...
    	if(year<1990||year>2019)
    		...
    		return false;
    	else if(year==2019&&month==10&&day>1)
    		return false;
    	else if((month==4||month==6||month==9||month==11)&&day>30)
    		return false;
    	else if(month==2){
    		if(year==1992||year==1996||year==2000||year==2004||year==2008||year==2012||year==2016)
			{
